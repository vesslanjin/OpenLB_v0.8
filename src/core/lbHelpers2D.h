...
const __m512d vc0 = _mm512_set_pd(c0, c0m4, c0, c0m4, c0, c0m4, c0, c0m16);
const __m512d vc1 = _mm512_set_pd(3.0, 3.0, 3.0, 0, -3.0, -3.0, -3.0, 0);
const __m512d vc2 = _mm512_set_pd(3.0, 0, -3.0, -3.0, -3.0, 0, 3.0, 0);
const __m512d vc3 = _mm512_set_pd(-1.5, 3.0, -1.5, -1.5, -1.5, 3.0, -1.5, -1.5);
const __m512d vc4 = _mm512_set_pd(-1.5, -1.5, -1.5, 3.0, -1.5, -1.5, -1.5, -1.5);
const __m512d vc5 = _mm512_set_pd(0, 0, 4.5, 0, 0, 0, 4.5, 0);
...
struct lbDynamicsHelpers<T, descriptors::D2Q9DescriptorBase<T> > {
  ...
  static void computeRhoU(T const* cell, T& rho, T u[2]) {
    ...
    /*
    T a = cell[5] + cell[6] + cell[7];
    T b = cell[1] + cell[2] + cell[3];
    
    rho = cell[0]+ a +cell[4]+ b +cell[8]+(T)1;
    T rcp_rho = (T)1/rho;
    u[0] = (a - b) * rcp_rho;
    u[1] = (cell[7] + cell[8] + cell[1] - cell[3] - cell[4] - cell[5] ) * rcp_rho;
   */
  }
