...
/// Implementation of the MRT collision step
template<typename T, template<typename U> class Lattice>
class SmagorinskyForcedMRTdynamics : public SmagorinskyMRTdynamics<T,Lattice> {
public:
  /// Constructor
  SmagorinskyForcedMRTdynamics(T omega_, Momenta<T,Lattice>& momenta_, T smagoConst_, T dx_, T dt_ ) : SmagorinskyMRTdynamics<T,Lattice>(omega_, momenta_, smagoConst_, dx_, dt_ ) {};
