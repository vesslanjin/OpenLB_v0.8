...
public:
  AdvectionDiffusionBoundaryConditionInstantiator2D( BlockStructure2D<T,Lattice>& block_ );
...
template<typename T, template<typename U> class Lattice, class BoundaryManager>
BlockStructure2D<T,Lattice>& AdvectionDiffusionBoundaryConditionInstantiator2D<T,Lattice,BoundaryManager>::getBlock()
{
  return block;
}

template<typename T, template<typename U> class Lattice, class BoundaryManager>
BlockStructure2D<T,Lattice> const& AdvectionDiffusionBoundaryConditionInstantiator2D<T,Lattice,BoundaryManager>::getBlock() const
{
  return block;
}
