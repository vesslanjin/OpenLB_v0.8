...
//	transpose(At);
	...
	const boost::numeric::ublas::matrix<Ta> At = boost::numeric::ublas::trans (A2);
...
*/
	...
	// x = AtAinv * At * y2;
	const boost::numeric::ublas::matrix<Ta> B  =
		boost::numeric::ublas::prod(AtAinv, At);
	const boost::numeric::ublas::vector<Ta> x2 = boost::numeric::ublas::prod(B, y2); //B * y2;
