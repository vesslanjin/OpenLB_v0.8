...
int main(int argc, char* argv[]) {
  ...
  OnLatticeBoundaryCondition2D<T,DESCRIPTOR>* boundaryCondition =
    createLocalBoundaryCondition2D<T,DESCRIPTOR,MRTdynamics<T,DESCRIPTOR> >(lattice);
  // createInterpBoundaryCondition2D<T,DESCRIPTOR,MRTdynamics<T,DESCRIPTOR> >(lattice);
